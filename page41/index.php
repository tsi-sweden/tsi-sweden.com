...
<head>
	...
	<link rel="stylesheet" href="http://www.powersystemstraining.co.uk/page41/files/stacks_in_279_page41_pagesafe.css" />
</head>
<body class="color  ">

<section id="pagesafe-wrapper" class="">

	<form id="pagesafe" class="input-pin icon-padlock digits4" method="post" action="http://www.powersystemstraining.co.uk/page41/files/stacks_in_279_page41_pagesafe.php" data-action="files/stacks_in_279_page41_pagesafe.php">
...
<footer id="pagesafe-footer">
	...
	<script src="http://www.powersystemstraining.co.uk/page41/files/stacks_in_279_page41_pagesafe.js"></script>
</body></html>
