...
<head>
	...
	<link rel="stylesheet" href="http://www.powersystemstraining.co.uk/page26/files/stacks_in_279_page26_pagesafe.css" />
</head>
<body class="color  ">

<section id="pagesafe-wrapper" class="">

	<form id="pagesafe" class="input-pin icon-padlock digits4" method="post" action="http://www.powersystemstraining.co.uk/page26/files/stacks_in_279_page26_pagesafe.php" data-action="files/stacks_in_279_page26_pagesafe.php">
...
<footer id="pagesafe-footer">
	...
	<script src="http://www.powersystemstraining.co.uk/page26/files/stacks_in_279_page26_pagesafe.js"></script>
</body></html>
